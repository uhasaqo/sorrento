...
export function Apartment(props) {
    return (
            ...
            <div className="apartment">
                ...
                <div className="grid">
                    <div className="card">
                    We are pet friendly and offer:
                    
                    <ul><li>A Queen-sized bedroom suite</li>
                        ...
                        <p>Your <b>luxury apartment</b> consists of: <ul><li>A spacious separate living area with leather furniture overlooking a private garden for you to enjoy.</li>
                ...
                <div className="card">
                <img src = {ApptFront} text = "Front view apartment" alt="Apartment front view" />
                <img src = {ApptGarden} text = "Apartment garden" alt="Apartment garden"/>
                <img src = {ApptBath} text = "Apartment bath" alt="Apartment bath" /> 
                </div>
