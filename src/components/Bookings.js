...
export function Bookings(props) {
    return (
        <div className="Bookings">
            ...
            <br></br>
            <h1>Bookings</h1>
            To make a booking, please text or call <strong><a href="tel: 0435 123 456" title="Click to call us!">0435 123 456</a> </strong> or use the form on our <b> <Link to="/contact">Contact</Link></b> page.
